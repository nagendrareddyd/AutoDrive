...
namespace AutoDriveAPI.ActionFilters
{
    /// <summary>
    ...
    public class GlobalExceptionAttribute : ExceptionFilterAttribute
    {
        public override void OnException(HttpActionExecutedContext context)
        {
            ...
            trace.Error(context.Request, "Controller : " + 
                context.ActionContext.ControllerContext.ControllerDescriptor.ControllerType.FullName + Environment.NewLine + "Action : " 
                + context.ActionContext.ActionDescriptor.ActionName + Environment.NewLine + "Stack Trace : " + context.Exception.StackTrace, context.Exception);
